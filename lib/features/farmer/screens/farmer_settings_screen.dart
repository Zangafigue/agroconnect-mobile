...
class FarmerSettingsScreen extends ConsumerStatefulWidget {
  const FarmerSettingsScreen({super.key});

  @override
  ConsumerState<FarmerSettingsScreen> createState() => _FarmerSettingsScreenState();
}

class _FarmerSettingsScreenState extends ConsumerState<FarmerSettingsScreen> {
  bool _newOrdersNotify = true;
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildValueItem(Icons.translate, 'Langue', 'Français', () => _showLanguageDialog(context)),

              // Notifications
              _buildSectionHeader('Notifications'),
              _buildToggleItem(Icons.shopping_basket_outlined, 'Nouvelles commandes', _newOrdersNotify, (v) => setState(() => _newOrdersNotify = v)),
              ...
              _buildNavigationItem(Icons.lock_reset, 'Changer mon mot de passe', () => _showPasswordResetDialog(context)),
              ...
              _buildNavigationItem(Icons.help_outline, 'Centre d\'aide', () => _showInfoSnackbar(context, 'Ouverture du centre d\'aide...')),
              _buildNavigationItem(Icons.support_agent, 'Contacter le service client', () => _showInfoSnackbar(context, 'Appel du service client...')),
              ...
              _buildNavigationItem(Icons.description_outlined, 'Conditions d\'utilisation', () => _showTermsOfService(context)),
              _buildNavigationItem(Icons.policy_outlined, 'Politique de confidentialité', () => _showPrivacyPolicy(context)),
              ...
              const Center(
                child: Text(
                  'AgroConnect BF © 2024 - Farmer Portal',
  ...
  void _showTermsOfService(BuildContext context) {
    _showPolicyModal(context, 'Conditions d\'utilisation', 'Ceci est une simulation des conditions d\'utilisation d\'AgroConnect BF pour les agriculteurs. En utilisant nos services, vous acceptez que vos données de vente et de localisation soient partagées avec les acheteurs et transporteurs concernés.');
  }

  void _showPrivacyPolicy(BuildContext context) {
    _showPolicyModal(context, 'Politique de confidentialité', 'Votre vie privée est notre priorité. AgroConnect BF s\'engage à protéger vos données personnelles d\'agriculteur et à ne les utiliser que pour améliorer votre expérience sur la plateforme.');
  }
  ...
  void _showPolicyModal(BuildContext context, String title, String content) {
    showModalBottomSheet(
      ...
      builder: (context) => Container(
        ...
        decoration: BoxDecoration(
          color: Theme.of(context).brightness == Brightness.dark ? AppConfig.surfaceDark : AppConfig.surfaceLight,
